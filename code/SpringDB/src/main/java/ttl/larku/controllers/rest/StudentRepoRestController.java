...
//                .toUri();
	...
	public ResponseEntity<?> deleteStudent(@PathVariable("id") int id) {
		Student s = studentService.getStudent(id);
		if (s == null) {
			RestResultWrapper<?> rr = RestResultWrapper.ofError("Student with id " + id + " not found");
	...
	public ResponseEntity<?> updateStudentR(@RequestBody Student student) {
		RestResultWrapper<?> result = studentService.updateStudentR(student);

		if (result.getStatus() != RestResultWrapper.Status.Ok) {
