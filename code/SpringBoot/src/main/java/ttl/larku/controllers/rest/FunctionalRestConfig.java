...
class FunctionalStudentHandler {
    ...
    public ServerResponse getAllStudents(ServerRequest request) {
        ...
        return ServerResponse.ok().body(RestResultWrapper.ofValue(students));
    }
    ...
    public ServerResponse createStudent(ServerRequest request) throws ServletException, IOException {
        ...
        return ServerResponse.created(newResource).body(RestResultWrapper.ofValue(s));
    }
    ...
    public ServerResponse getStudent(ServerRequest request) {
        ...
        if (s == null) {
            return ServerResponse.badRequest().body(RestResultWrapper.ofError("Student with id: " + id + " not found"));
        }
        return ServerResponse.ok().body(RestResultWrapper.ofValue(s));
    }
